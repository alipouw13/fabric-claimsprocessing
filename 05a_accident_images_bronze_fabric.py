...
try:
    ...
    (bronze_metadata_df.write
     ...
     .saveAsTable("bronze_image_metadata"))
...
try:
    ...
    bronze_metadata = spark.table("bronze_image_metadata")
...
🎯 USAGE:
   • Use bronze_image_metadata for metadata-only queries
   • Use bronze_images for image processing workflows
   • Use bronze_accident for combined analysis
